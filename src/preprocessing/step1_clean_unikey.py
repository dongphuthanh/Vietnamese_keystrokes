...
def un_to_dot(data):
    ...
    for i in range(len(data["keystrokes"])):
        if data["keystrokes"][i]["key"]=="Unidentified" and data["keystrokes"][i]["event"]=="keydown":
            data["keystrokes"][i]["key"]="·"
        if not v:
            if data["keystrokes"][i]["key"]=="c" or data["keystrokes"][i]["key"]==" " or data["keystrokes"][i]["key"]=="a":
                if data["keystrokes"][i]["code"]=="":
                    data["keystrokes"][i]["key"]="Unidentified"
        if data["keystrokes"][i]["key"]==" ·":
            data["keystrokes"][i]["key"]="·"
        if data["keystrokes"][i]["key"]=="ư":
            if data["keystrokes"][i-1]["key"]!="Backspace" and data["keystrokes"][i-2]["key"]!="Backspace":
                data["keystrokes"][i]["key"]="w"
                data["keystrokes"][i]["code"]="KeyW"
    return data
...
def real_or_fake(data):
    ...
    if search2(data):
        for i in range(1,len(data["keystrokes"])-1):
            if "actual" in data["keystrokes"][i]:
                continue
            if data["keystrokes"][i]["key"]=="·":
            ...
            elif data["keystrokes"][i]["code"]=="" and len(data["keystrokes"][i]["key"])==1:
                data["keystrokes"][i]["actual"]="indicate"
            elif data["keystrokes"][i]["code"]=="":
