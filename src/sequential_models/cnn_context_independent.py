...
for fold in range(n_splits):
    ...
    study = optuna.create_study(direction="maximize",study_name=study_name, sampler=sampler, storage="sqlite:///optuna_studies/cnn_cie.db", load_if_exists=True)
...
plt.tight_layout()
plt.savefig(f"figures/cnn_cie_{SCENARIO}_confusion_matrix.png", dpi=300, bbox_inches='tight')
plt.close()
