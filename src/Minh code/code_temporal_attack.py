...
def extract_features_from_folder(folder_path, pickle_path, top_bigrams):
    ...
    print(f"Saved {len(all_features)} normal rows")
...
# --- Chạy cả 2 ---
folder_path = "/home/mtcd001/Downloads/Attack-20260308T231525Z-1-001/Attack"

# Tính top bigrams từ CẢ HAI folder
normal_folder = "/home/mtcd001/Downloads/preproccessed-20260308T221840Z-1-001/preproccessed"
attack_folder = "/home/mtcd001/Downloads/Attack-20260308T231525Z-1-001/Attack"

# Merge bigrams từ cả 2
top_bigrams = get_top_bigrams_from_folder(normal_folder, top_n=200)

# Extract normal
extract_features_from_folder(normal_folder, "/home/mtcd001/PycharmProjects/Vietnamese_keystrokes/src/full.pkl", top_bigrams)

# Extract attack
extract_attack_features(attack_folder, "/home/mtcd001/PycharmProjects/Vietnamese_keystrokes/src/attack.pkl", top_bigrams)