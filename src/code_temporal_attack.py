...
# --- Chạy cả 2 ---
folder_path = "/home/mtcd001/Downloads/Attack-20260306T014439Z-1-001/Attack"

top_bigrams = get_top_bigrams_from_folder(folder_path, top_n=200)
print("Top bigrams computed.")

extract_features_from_folder(folder_path, "full.pkl", top_bigrams)
extract_attack_features(folder_path, "attack.pkl", top_bigrams)